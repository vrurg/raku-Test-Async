...
Throws a [`Type::Async::X`](https://raku.land/?q=Type::Async::X) exception. `%c` is used as exception constructor profile to which `hub` named parameter is added.
...
# SEE ALSO
  ...
  - [`Test::Async::Result`](Result.md)

  - [`Test::Async::TestTool`](TestTool.md)
...
See the [*LICENSE*](../../../../LICENSE) file in this dis
