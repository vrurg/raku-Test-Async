...
use Test::Async; say test-suite.^mro(:roles).map(\*.^shortname).join(", ") results in:
...
See example script: [*examples/multi-bundle/multi-bundle.raku*](../../../../examples/multi-bundle/multi-bundle.raku)
...
# SEE ALSO
  ...
  - [`Test::Async::CookBook`](CookBook.md)

  - [`Test::Async::Base`](Base.md)

  - [`Test::Async::When`](When.md)
