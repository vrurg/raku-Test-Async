...
Class defines a job entry for [`Test::Async::JobMgr`](https://github.com/vrurg/raku-Test-Async/blob/v0.0.16/docs/md/Test/Async/JobMgr.md).
...
[`Test::Async::JobMgr`](https://github.com/vrurg/raku-Test-Async/blob/v0.0.16/docs/md/Test/Async/JobMgr.md), [`Test::Async::Hub`](https://github.com/vrurg/raku-Test-Async/blob/v0.0.16/docs/md/Test/Async/Hub.md)
