...
Creates a [`Test::Async::Result`](https://github.com/vrurg/raku-Test-Async/blob/v0.1.900/docs/md/Test/Async/Result.md) object using the provided parameters. `$fail` and `$success` are shortcut names for corresponding `-profile` attributes of `Test::Async::Result` class.
