...
L<C<Test::Async::Utils>|https://github.com/vrurg/raku-Test-Async/blob/v0.1.2/docs/md/Test/Async/Utils.md> C<stringify> routine and then passes over to the first candidate for formatting alongside with
...
L<C<Test::Async>|https://github.com/vrurg/raku-Test-Async/blob/v0.1.2/docs/md/Test/Async.md>
and L<C<Test::Async::CookBook>|https://github.com/vrurg/raku-Test-Async/blob/v0.1.2/docs/md/Test/Async/CookBook.md>
for more details.
...
(I<implemented by L<C<Test::Async::Reporter::TAP>|https://github.com/vrurg/raku-Test-Async/blob/v0.1.2/docs/md/Test/Async/Reporter/TAP.md> and might not be supported by 3rd party reporters>)
