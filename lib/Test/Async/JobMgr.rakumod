...
attribute of L<C<Test::Async::Hub>|https://github.com/vrurg/raku-Test-Async/blob/v0.0.15/docs/md/Test/Async/Hub.md>, for example.
...
Creates a new job instance of L<C<Test::Async::Job>|https://github.com/vrurg/raku-Test-Async/blob/v0.0.15/docs/md/Test/Async/Job.md>
...
L<C<Test::Async::Manual>|https://github.com/vrurg/raku-Test-Async/blob/v0.0.15/docs/md/Test/Async/Manual.md>,
L<C<Test::Async::Job>|https://github.com/vrurg/raku-Test-Async/blob/v0.0.15/docs/md/Test/Async/Job.md>,
